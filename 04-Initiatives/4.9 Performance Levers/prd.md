# Merchant Performance & Delivery Capacity PRD
...
| **Phase 2** | Personalisation + Intent | User-based recommendations + intent-aware exposure | CTR lever for targeted exposure based on user behaviour and session intent |
...
**Dependencies:**
- Phase 4 depends on [prd.md](./../4.6%20Impression%20Infrastructure/prd.md) for exposure measurement and delivery pacing
...
Introduce **paid visibility as a pricing layer** on top of understood economics. Depends on [prd.md](./../4.6%20Impression%20Infrastructure/prd.md).
| Lever | Description | Success Metric |
| --- | --- | --- |
